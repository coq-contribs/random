...
Add Parametric Relation (A : Type) : (@distr A) (@eq_distr A)
    reflexivity proved by (@eq_distr_refl A)
    symmetry proved by (@eq_distr_sym A)
    transitivity proved by (@eq_distr_trans A) as Distr_Setoid.

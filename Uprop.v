...
Add Parametric Relation (A : Type) : (A -> U) (@feq A)
    reflexivity proved by (@feq_refl A)
    symmetry proved by (@feq_sym A)
    transitivity proved by (@feq_trans A) as f_Setoid.

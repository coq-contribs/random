...
CoqMakefile.conf: _CoqProject
	coq_makefile -f _CoqProject Bernoulli.v Carac.v Choice.v IterFlip.v Libwp.v Monads.v Nelist.v Prelude.v Probas.v Prog.v Sets.v Transitions.v Ubase.v Uprop.v Ycart.v
